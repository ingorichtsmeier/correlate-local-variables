...
/**
 * This is an easy adapter implementation illustrating how a Java Delegate can be used from within a
...
public class LoggerDelegate implements JavaDelegate {
  ...
  public void execute(DelegateExecution execution) throws Exception {
    ...
    LOGGER.info("\n\n  ... LoggerDelegate invoked by " + "activityName='"
        ...
        + ", executionId=" + execution.getId() + ", variables=" + execution.getVariables()
        + " \n\n");
    if (execution.getVariable("wait") != null && execution.getVariable("wait").equals(true)) {
      Thread.sleep(5000);
    }
    LOGGER.info("wake up again " + execution.getCurrentActivityId());
  }
